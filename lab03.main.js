 ...
 * @return {{ipv4: string, ipv6: ?string}} (firstIpAddress) - An object containing the address in IPv4 and IPv6 formats.
 */
...
function main() {
  ...
  for (let i = 0; i < sampleCidrsLen; i++) {
    ...
    getFirstIpAddress(sampleCidrs[i], (data, error) => {
      ...
      console.log(`  Response returned from GET request: ${JSON.stringify(data, 4)}`);
    });
  }
